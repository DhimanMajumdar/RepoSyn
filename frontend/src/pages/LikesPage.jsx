...
const LikesPage = () => {
  return (
    <div className="relative overflow-x-auto shadow-md rounded-lg px-4">
      <table
        className="w-full text-sm text-left rtl:text-right bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 
		hover:bg-gray-600/10 border border-gray-800 text-white overflow-hidden"
      >
        <thead
          className="text-xs uppercase bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 
